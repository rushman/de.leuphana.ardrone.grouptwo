...
import de.leuphana.ardrone.dronesystem.old.domain.Command;
import de.leuphana.ardrone.dronesystem.old.domain.Commands;
import de.leuphana.ardrone.dronesystem.old.domain.DroneState;
...
public class DroneCommandSender {
	 ...
	 * 
	 * @see de.leuphana.ardrone.dronesystem.old.DroneCommandSender#turnHorz(float f)
	 * @param command
	 * @return
	 */
